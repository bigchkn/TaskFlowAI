...
- [x] **TF-54**: Task templates do not show included templates(`Done`)
  ...
  - [x] **TF-55**: Write LLD (Parent: TF-54)(`Done`)
  - [x] **TF-56**: Implementation (Parent: TF-54)(`Done`)
...
- [x] **TF-60**: Create built-in task type task which does not strictly require LLD to capture defined work items(`Done`)
  - [Lld] docs/designs/Backlog/TF-60/lld-create-built-in-task-type-task-which-does-not-strictly-require-lld.md (`Draft`)
  - [x] **TF-61**: Write LLD (Parent: TF-60)(`Done`)
  - [x] **TF-62**: Implementation (Parent: TF-60)(`Done`)
